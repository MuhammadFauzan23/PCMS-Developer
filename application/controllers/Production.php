...
class Production extends CI_Controller
{
	...
	{
		$da = $this->ProductionModel->get_last_num()->row_array();
		$number = !isset($da['material_number']) ? 1 : $da['material_number'] + 1;
		$data = [
			'title' => 'Temporary',
	...
	{
		$getlastNumber = $this->db->query('SELECT material_number FROM tbl_material ORDER BY material_number DESC LIMIT 1')->row_array();
		if (is_null($getlastNumber['material_number'])) {
			$number = 1;
		} else {
			$number = $getlastNumber['material_number'] + 1;
		}
