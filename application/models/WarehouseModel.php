...
class WarehouseModel extends CI_Model
{
    function get_data_material()
    {
        ...
        JOIN tbl_material ON tbl_material.username = tbl_user.username")->result();
    }
    ...
    function data_material($materialID)
    {
        return $this->db->query("SELECT tbl_material.*, tbl_user.* FROM tbl_material 
            JOIN tbl_user ON tbl_user.username = tbl_material.username  WHERE tbl_material.material_number = '$materialID'")->result();
    }
    ...
    function data_material_detail($materialID)
    {
        ...
        JOIN tbl_user ON tbl_user.username = tbl_material.username	
